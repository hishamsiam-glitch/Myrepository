...
// and never committed. See android/key.properties.example. Without it the
// release build falls back to the debug key, which is fine for installing on
// your own device but not for a Play Store upload.
...
android {
    namespace = "com.hishamsiam.chess"
    ...
    defaultConfig {
        applicationId = "com.hishamsiam.chess"
